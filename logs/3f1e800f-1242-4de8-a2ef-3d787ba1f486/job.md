...
**Search Area:** 30 miles around zip code 06002
...
## The Leads
1. Anytime Sewer & Drain Services
   - Category: Plumber
...
3. Joe the Plumber
   ...
   - Initial Score: 70/100
   - Why: Has no website; Well-reviewed (4.6 stars); Established business (536 reviews)

## REQUIRED Output Files (Create ALL of these):

### 1. Create LEAD_ANALYSIS.md
...
### 3. Create TELEGRAM_MESSAGE.md
Write a quick summary for Telegram notification:
- Top 3 picks with scores
- One-line reason for each
- Keep it concise (under 500 chars)

**IMPORTANT:** You MUST create all three files. The system will automatically send the email and Telegram message based on these files.
